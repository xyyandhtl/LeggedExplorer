...
from vla_explorer.matterport.config import MatterportImporterCfg
...
from vla_explorer.envs.vlnce.utils import ASSETS_DIR
import vla_explorer.envs.vlnce.mdp as mdp
...
@configclass
class Go2VlnceMp3dBaseEnvCfg(ManagerBasedRLEnvCfg):
